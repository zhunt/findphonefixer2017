...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <h3 class="panel-title"><?= h($country->name) ?></h3>
    </div>
    <table class="table table-striped" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td><?= __('Intro Text') ?></td>
            <td><?= $this->Text->autoParagraph(h($country->intro_text)); ?></td>
        </tr>
    </table>
</div>
...
<div class="panel panel-default">
    <!-- Panel header -->
    <div class="panel-heading">
        <h3 class="panel-title"><?= __('Related Provinces') ?></h3>
    </div>
        ...
        <table class="table table-striped">
            ...
            <?php foreach ($country->provinces as $provinces): ?>
                <tr>
                    ...
                    <td><?= h($provinces->seo_desc) ?></td>
                    <td><?= h($provinces->intro_text) ?></td>
                    <td><?= h($provinces->country_id) ?></td>
                    <td class="actions">
                        <?= $this->Html->link('', ['controller' => 'Provinces', 'action' => 'view', $provinces->], ['title' => __('View'), 'class' => 'btn btn-default glyphicon glyphicon-eye-open']) ?>
                        <?= $this->Html->link('', ['controller' => 'Provinces', 'action' => 'edit', $provinces->], ['title' => __('Edit'), 'class' => 'btn btn-default glyphicon glyphicon-pencil']) ?>
                        <?= $this->Form->postLink('', ['controller' => 'Provinces', 'action' => 'delete', $provinces->], ['confirm' => __('Are you sure you want to delete # {0}?', $provinces->), 'title' => __('Delete'), 'class' => 'btn btn-default glyphicon glyphicon-trash']) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
    ...
    <?php else: ?>
        <p class="panel-body">no related Provinces</p>
    <?php endif; ?>
</div>
<div class="panel panel-default">
    <!-- Panel header -->
